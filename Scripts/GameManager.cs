    ...
    void Start()
    {
        ...
        for (int i = 0; i < TrucksCount; i++)
        {
            ...
            if (gob.name == StartCar)
            {
                ...
                currentCamera.transform.SetParent(car.transform);
                currentCamera.transform.localPosition = new Vector3(0, 5, -10);
                Quaternion qu = new Quaternion();
                qu.eulerAngles = new Vector3(10, 0, 0);
                currentCamera.transform.localRotation = qu;
                currentCamera.transform.localScale = new Vector3(0, 0, 0);
                car.SetActive(true);
